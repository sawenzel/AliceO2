...
const boost::shared_ptr<bpo::option_description>
  SimConfig::kEventBoostOption(new bpo::option_description("nEvents,n", bpo::value<unsigned int>()->default_value(1), "number of events"));

// = boost::make_shared<bpo::option_description>("nEvents,n", bpo::value<unsigned int>()->default_value(1), "number of events");
