...
void GeneratorService::initService(std::string const& genName, VertexOption const& vxtOption)
{
  ...
  if (dynamic_cast<MeanVertexObjectOption const*>(&vxtOption) != nullptr) {
    ...
    //}
    // mPrimGen->setVertexMode(VertexMode::kCCDB, ccdboption->meanvertexObject);
