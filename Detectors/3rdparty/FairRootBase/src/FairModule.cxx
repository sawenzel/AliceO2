...
// FairModule::ProcessNodes() removed: it imported ASCII-geometry nodes into the
// FairRuntimeDb 'FairGeoParSet' container. O2 builds geometry natively with TGeo
// and the runtime database is gone.
