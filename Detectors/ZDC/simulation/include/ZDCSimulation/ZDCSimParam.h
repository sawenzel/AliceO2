...
struct ZDCSimParam : public o2::conf::ConfigurableParamHelper<ZDCSimParam> {
  ...
  /// there. This is what the ZDC costs in transport time; turning it off leaves
  /// the ZEM calorimeters at z ~ 7.6 m, whose material is in the FIT and FDD
  /// acceptance, in the geometry.
