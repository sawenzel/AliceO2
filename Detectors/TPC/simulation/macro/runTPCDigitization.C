...
void getHits(std::vector<std::vector<o2::TPC::HitGroup>*>& hitvectors, std::vector<TPCHitGroupID>& hitids,
		const std::vector<o2::MCInteractionRecord>& times,
...
void loopHits(const std::vector<std::vector<o2::TPC::HitGroup>*>& hitvectors,
		      const std::vector<TPCHitGroupID>& hitids,
