...
TRDSimParam *TRDSimParam::fgInstance   = 0;
Bool_t          TRDSimParam::fgTerminated = kFALSE;
...
//_____________________________________________________________________________
Double_t TRDSimParam::TimeResponse(Double_t time) const
{
  //
...
//_____________________________________________________________________________
Double_t TRDSimParam::CrossTalk(Double_t time) const
{
  //
