...
TRDCommonParam *TRDCommonParam::fgInstance = 0;
Bool_t TRDCommonParam::fgTerminated = kFALSE;
...
//_____________________________________________________________________________
Float_t TRDCommonParam::GetOmegaTau(Float_t vdrift)
{
  /*
  //
...
//_____________________________________________________________________________
Bool_t TRDCommonParam::GetDiffCoeff(Float_t &dl, Float_t &dt, Float_t vdrift)
{
  /*
  //
...
//_____________________________________________________________________________
Double_t TRDCommonParam::TimeStruct(Float_t vdrift, Double_t dist, Double_t z)
{
  //
  ...
  if ((r1  <  0) || 
      ...
      (kz1 <  0) || 
      (kz1 > 10)) {
    LOG(INFO) << Form("Indices out of range: dist=%.2f, z=%.2f, r1=%d, kz1=%d"
                   ,dist,z,r1,kz1);
  }
...
//_____________________________________________________________________________
void TRDCommonParam::SampleTimeStruct(Float_t vdrift)
{
  //
