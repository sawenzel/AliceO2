...
xterm -geometry 80x25+0+0 -e "O2PrimaryServerDeviceRunner --control static --id primary-server --mq-config ~/alisw_new/O2/run/primary-server.json -n 10 -m TPC -e TGeant3 | tee serverlog;bash" &
