...
struct GeneratorTask {
  ...
  Configurable<std::string> trigger{"trigger", "", "Trigger"}; // <---- to be treated
  ...
  // we might also need a run or timestamp to fetch CCDB Vertex
  ...
  void init(o2::framework::InitContext& /*ic*/)
  {
    ...
    if (vtxmode == o2::conf::VertexMode::kDiamondParam) {
      genservice.initService(generator, o2::eventgen::DiamondParamVertexOption());
    } else if (vtxmode == o2::conf::VertexMode::kNoVertex) {
      genservice.initService(generator, o2::eventgen::NoVertexOption());
