...
struct TOFHitStats {
  ...
  // adds a hit to the statistics
  void addHit(o2::tof::HitType const& hit)
  {
    NHits++;
    auto x = hit.GetX();
    XAvg += x;
...
{
  auto refresult = analyse<o2::tof::HitType, TOFHitStats>(reftree, "TOFHit");
  refresult.print();
  auto testresult = analyse<o2::tof::HitType, TOFHitStats>(testtree, "TOFHit");
  testresult.print();
}
