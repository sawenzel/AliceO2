...
void build_geometry(FairRunSim* run = nullptr)
{
  ...
  std::vector<int> detId2RunningId = std::vector<int>(o2::detectors::DetID::nDetectors); // a mapping of detectorId to a dense runtime index
  // used for instance to set bits in the hit structure of MCTracks
