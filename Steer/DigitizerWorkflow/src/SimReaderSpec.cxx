...
DataProcessorSpec getSimReaderSpec(SubspecRange range, const std::vector<std::string>& simprefixes, const std::vector<int>& tpcsectors, bool withTrigger)
{
  ...
  auto doit = [range, tpcsectors, activeSectors, withTrigger, ctptrigger](ProcessingContext& pc) {
  ...
  auto initIt = [simprefixes, doit, withTrigger, &ctptrigger](InitContext& ctx) {
